<%@ Page Title="" Language="C#" MasterPageFile="~/EGlobalCustomer.Master" AutoEventWireup="true" CodeBehind="MyOrders.aspx.cs" Inherits="EGlobalLtd.MyOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderCustomer" runat="server">
    <table style="width: 100%;">
        <tr>
             <td class="auto-style1" colspan="3">
                ...
                <strong>
                <asp:Label ID="lblCaption" runat="server" BackColor="#1880A5" BorderStyle="None" Font-Size="Medium" Height="22px" Width="1000px" CssClass="auto-style43" ForeColor="White">Purchase Orders</asp:Label>
                </strong></td>
        </tr>
        <tr>
            <td class="auto-style1" style="width:320px">&nbsp;</td>
    ...
    <asp:GridView ID="GridViewPOList" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="140px" Width="834px" OnSelectedIndexChanged="GridViewPOList_SelectedIndexChanged">
        ...
        <tr>
            <td class="auto-style1" style="width:320px">&nbsp;</td><td class="auto-style1" colspan="2">
